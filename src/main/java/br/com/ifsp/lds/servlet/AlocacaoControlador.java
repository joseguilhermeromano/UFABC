...
public class AlocacaoControlador implements Tarefa {
    ...
    public String cadastrar(HttpServletRequest req, HttpServletResponse resp) {
        ...
        System.out.print(req.getParameter("codCol"));
        try {
            ...
            if (validation.executaRegras()) {
                Usuario usuario = new UsuarioDAO().Consultar(Integer.parseInt(req.getParameter("codCol")));
    ...
    /**
     * Efetua o procedimento para consultar todos os treinamentos e usuarios e
     * os registram na requisição
     *
     * @param req
     * @param resp
     */
